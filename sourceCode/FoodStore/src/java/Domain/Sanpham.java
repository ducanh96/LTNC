...
public class Sanpham  implements java.io.Serializable {
    ...
    public Sanpham(String maSp, String tenSp, Long giaSp, String anhSp, String motaSp, Boolean trangThai, Set<Comment> comments, Set<Chitietdonhang> chitietdonhangs) {
       this.maSp = maSp;
       this.tenSp = tenSp;
       this.giaSp = giaSp;
       this.anhSp = anhSp;
